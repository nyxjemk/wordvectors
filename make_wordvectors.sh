...
############## START ###################
lcode="sv" # ISO 639-1 code of target language. See `lcodes.txt`.
max_corpus_size=4000000000 # the maximum size of the corpus. Feel free to adjust it according to your computing power.
...
vocab_size=500000 # the maximum vocabulary size
